      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-16 overflow-hidden border-b border-slate-100">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          <div className="flex items-center gap-6 mb-8">
            ...
            <h1 className="text-4xl md:text-7xl font-bold text-slate-950 tracking-tight leading-none italic uppercase">Cookie <span className="text-emerald-600">Protocols.</span></h1>
          </div>
          ...
          <div className="bg-slate-50 p-8 md:p-20 rounded-[3rem] border border-slate-100 shadow-xl space-y-20">
            <section className="space-y-6">
              <h2 className="text-2xl font-bold text-slate-950 uppercase tracking-widest border-b border-slate-200 pb-4 flex items-center gap-4">
                <div className="w-2 h-2 bg-emerald-600 rounded-full" /> 01. What Are Cookies?
              </h2>
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-bold text-slate-950 uppercase tracking-widest border-b border-slate-200 pb-4 flex items-center gap-4">
                <div className="w-2 h-2 bg-emerald-600 rounded-full" /> 02. Usage Logic
              </h2>
              <p className="text-slate-600 text-lg leading-relaxed">
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-bold text-slate-950 uppercase tracking-widest border-b border-slate-200 pb-4 flex items-center gap-4">
                <div className="w-2 h-2 bg-emerald-600 rounded-full" /> 03. Control & Opt-Out
              </h2>
              <p className="text-slate-600 text-lg leading-relaxed">
            ...
            <div className="pt-10 border-t border-slate-200">
              <p className="text-slate-600 text-lg">
                For detailed technical data on our cookie implementation, contact <span className="text-emerald-600 font-bold border-b border-emerald-500/30">precision@vishray.io</span>.
              </p>
            </div>
          </div>
        </div>
