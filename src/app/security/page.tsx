      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          <div className="flex items-center gap-6 mb-8">
            ...
            <h1 className="text-4xl md:text-7xl font-bold text-white tracking-tight leading-none italic uppercase">System <span className="text-emerald-500">Security.</span></h1>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <div key={idx} className="glass-dark p-12 rounded-[30px] border border-white/5 hover:border-emerald-500/20 transition-all group">
                <div className="w-12 h-12 rounded-xl bg-emerald-500/10 flex items-center justify-center mb-8 group-hover:bg-emerald-500 group-hover:text-slate-950 transition-all duration-500">
                  {item.icon}
                </div>
          ...
          <div className="mt-20 glass-dark p-12 rounded-[50px] border border-white/5 text-center">
             ...
             <Link href="/contact" className="bg-emerald-500 text-slate-950 px-10 py-4 rounded-xl font-bold hover:bg-emerald-400 transition-colors shadow-xl shadow-emerald-500/20">
