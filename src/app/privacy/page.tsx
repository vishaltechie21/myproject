      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-16 overflow-hidden border-b border-slate-100">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          <div className="flex items-center gap-6 mb-8">
            ...
            <h1 className="text-4xl md:text-7xl font-bold text-slate-950 tracking-tight leading-none italic uppercase">Privacy <span className="text-emerald-600">Policy.</span></h1>
          </div>
          ...
          <div className="bg-slate-50 p-8 md:p-20 rounded-[3rem] border border-slate-100 shadow-xl space-y-20">
            <section className="space-y-6">
              <h2 className="text-2xl font-bold text-slate-950 uppercase tracking-widest border-b border-slate-200 pb-4 flex items-center gap-4">
                <div className="w-2 h-2 bg-emerald-600 rounded-full" /> 01. Information Logic
              </h2>
              <div className="prose prose-slate max-w-none text-slate-600 text-lg leading-relaxed">
                ...
                <ul className="list-none space-y-4 pl-4 border-l border-emerald-500/20 py-4">
                  <li><strong className="text-slate-950">Core Identity:</strong> Name, secure email, and company logic metadata.</li>
                  <li><strong className="text-slate-950">Operational Telemetry:</strong> High-velocity interaction data, IP routing, and system heuristics.</li>
                  <li><strong className="text-slate-950">Neural Tokens:</strong> Small persistent data units to maintain state and optimize logic flow.</li>
                </ul>
              </div>
            </section>
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-bold text-slate-950 uppercase tracking-widest border-b border-slate-200 pb-4 flex items-center gap-4">
                <div className="w-2 h-2 bg-emerald-600 rounded-full" /> 02. Data Processing
              </h2>
              <div className="prose prose-slate max-w-none text-slate-600 text-lg leading-relaxed">
                <p>
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-bold text-slate-950 uppercase tracking-widest border-b border-slate-200 pb-4 flex items-center gap-4">
                <div className="w-2 h-2 bg-emerald-600 rounded-full" /> 03. Secure Architecture
              </h2>
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-bold text-slate-950 uppercase tracking-widest border-b border-slate-200 pb-4 flex items-center gap-4">
                <div className="w-2 h-2 bg-emerald-600 rounded-full" /> 04. Data Sovereignty
              </h2>
              <p className="text-slate-600 text-lg leading-relaxed">
                You maintain total sovereignty over your data logic. To request extraction or deletion of your telemetry from our ecosystem, contact our security architect at <span className="text-emerald-600 font-bold border-b border-emerald-500/30">precision@vishray.io</span>.
              </p>
            </section>

            <section className="space-y-6">
              <h2 className="text-2xl font-bold text-slate-950 uppercase tracking-widest border-b border-slate-200 pb-4 flex items-center gap-4">
                <div className="w-2 h-2 bg-emerald-600 rounded-full" /> 05. Protocol Updates
              </h2>
              <p className="text-slate-600 text-lg leading-relaxed">
