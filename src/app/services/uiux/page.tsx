    ...
    <div ref={containerRef} className="bg-slate-950 min-h-screen pb-32">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16">
               <div className="flex-1 space-y-8 w-full">
                  ...
                  <h1 className="text-4xl md:text-6xl lg:text-8xl font-bold text-white tracking-tight leading-[0.9] italic">
                     Design That <span className="text-emerald-500">Drives</span> Logic.
                  </h1>
      ...
      <section className="py-24 lg:py-40 max-w-7xl mx-auto px-6 text-center">
         <div className="space-y-4 mb-20">
            <h2 className="text-[10px] font-bold uppercase tracking-widest text-emerald-500">Our Creative Methodology</h2>
            <h3 className="text-4xl md:text-6xl font-bold text-white tracking-tight leading-none italic uppercase">Aesthetic <span className="text-emerald-500">Strategy.</span></h3>
         </div>
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((f, i) => (
              <div key={i} className="group p-10 glass-dark rounded-[3rem] border border-white/5 hover:border-emerald-500/30 transition-all text-center">
                 ...
                 <p className="text-slate-400 font-medium leading-relaxed">Harmonizing visual excellence with high-fidelity functional logic.</p>
              </div>
            ))}
         </div>
      </section>
