      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          <div className="flex items-center gap-6 mb-8">
            ...
            <h1 className="text-4xl md:text-7xl font-bold text-white tracking-tight leading-none italic uppercase">Operational <span className="text-emerald-500">Disclaimer.</span></h1>
          </div>
          ...
          <div className="glass-dark p-8 md:p-20 rounded-[3rem] border border-white/5 shadow-2xl space-y-20">
            <section className="space-y-6">
              <h2 className="text-2xl font-bold text-white uppercase tracking-widest border-b border-white/5 pb-4 flex items-center gap-4">
                <div className="w-2 h-2 bg-emerald-500 rounded-full" /> 01. External Vectors
              </h2>
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-bold text-white uppercase tracking-widest border-b border-white/5 pb-4 flex items-center gap-4">
                <div className="w-2 h-2 bg-emerald-500 rounded-full" /> 02. Data Accuracy
              </h2>
              <p className="text-slate-400 text-lg leading-relaxed">
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-bold text-white uppercase tracking-widest border-b border-white/5 pb-4 flex items-center gap-4">
                <div className="w-2 h-2 bg-emerald-500 rounded-full" /> 03. Performance Metrics
              </h2>
              <p className="text-slate-400 text-lg leading-relaxed">
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-bold text-white uppercase tracking-widest border-b border-white/5 pb-4 flex items-center gap-4">
                <div className="w-2 h-2 bg-emerald-500 rounded-full" /> 04. System Errors
              </h2>
              <p className="text-slate-400 text-lg leading-relaxed">
            ...
            <section className="space-y-6">
              <h2 className="text-2xl font-bold text-white uppercase tracking-widest border-b border-white/5 pb-4 flex items-center gap-4">
                <div className="w-2 h-2 bg-emerald-500 rounded-full" /> 05. Technical Advice
              </h2>
              <p className="text-slate-400 text-lg leading-relaxed">
            ...
            <div className="pt-10 border-t border-white/5">
              <p className="text-slate-400 text-lg">
                For legal inquiries regarding these protocols, contact our counsel at <span className="text-emerald-500 font-bold border-b border-emerald-500/30">precision@vishray.io</span>.
              </p>
            </div>
          </div>
        </div>
